...
func CheckUserReferalDuplicate(user models.UserRefrence) (models.UserRefrence, string, error) {
	...
	query := bson.M{
		"$or": []bson.M{
			{"referredBy.email": user.ReferedBy.Email},
			{"referredBy.mobile": user.ReferedBy.Mobile},
		},
	}
